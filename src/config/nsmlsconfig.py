...
nsm_clients = [
        ...
        Client("ardour6", "DAW", "https://ardour.org"),
        Client("ardour7", "DAW", "https://ardour.org"),
        ...
        Client("mixbus", "DAW", "https://harrisonconsoles.com"),  # FIXME
        ...
        Client("qtractor", "DAW", "https://github.com/rncbc/qtractor"),
